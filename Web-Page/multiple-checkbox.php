            ...
            <div class="col column-6 column-offset-20">
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <label for="cbl" class="label-inline">Lemon</label>
                    </div>
                    <div>
                        <input type="checkbox"name="fruits[]" <?php isFruitChecked('orange')?> value="orange">
                        <label for="cbl" class="label-inline">Orange</label>
                    </div>
                    <div>
                        <input type="checkbox" name="fruits[]" <?php isFruitChecked('mango')?> value="mango">
                        <label for="cbl" class="label-inline">Mango</label>
                    </div>
                    <div>
                        <input type="checkbox" name="fruits[]" <?php isFruitChecked('grape')?> value="grape">
                        <label for="cbl" class="label-inline">Grape</label>
                    </div>
